...
| Transmission line proximity <br>`pwr.transmission_proximity` | 2.68 | km | 93 | 9 | A (machine API) |
...
| Organized opposition risk <br>`com.opposition_risk` | organized_opposition | category | 20 | 8 | C (researched) |
| Modeled 10-year TCO <br>`eco.total_cost_of_ownership` | — | USD_per_kW_year | — | 8 | — (unmeasured) |
| Zoning and entitlement status <br>`lnd.zoning_status` | rezoning_contested | category | 28 | 8 | C (researched) |
...
| Dry-bulb temperature profile and free-cooling hours <br>`clm.dry_bulb_profile` | 6940.8 | free_cooling_hours_per_year | 86 | 7 | A (machine API) |
| Residential proximity and noise exposure <br>`com.residential_proximity` | 37 | dwellings_within_1km | 83 | 7 | A (machine API) |
...
| Wet-bulb temperature profile <br>`wtr.wetbulb_profile` | 347.5 | hours_above_24C_wetbulb | 78 | 7 | A (machine API) |
...
| Terrain slope <br>`lnd.slope` | 0.99 | percent_slope | 98 | 6 | A (machine API) |
...
| Extreme heat trend to 2050 <br>`clm.extreme_heat_trend` | 1.69 | delta_C_design_day_2050 | 62 | 5 | D (modeled) |
...
| Port and rail access <br>`eco.port_rail_access` | 4.21 | km_to_capable_port_or_rail | 99 | 4 | B (bulk/structured) |
...
| Internet exchange and cloud on-ramp proximity <br>`cnx.ixp_proximity` | 8.58 | km | 96 | 3 | A (machine API) |
