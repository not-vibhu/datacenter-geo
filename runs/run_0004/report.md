...
| Contiguous developable area <br>`lnd.contiguous_area` | 4162.6 | hectares | 100 | 9 | C (researched) |
| Transmission line proximity <br>`pwr.transmission_proximity` | 18.57 | km | 48 | 9 | A (machine API) |
...
| On-site generation potential <br>`pwr.onsite_generation_potential` | 56.0 | index_0_100 | 56 | 8 | B (bulk/structured) |
...
| Dry-bulb temperature profile and free-cooling hours <br>`clm.dry_bulb_profile` | 2274.7 | free_cooling_hours_per_year | 32 | 7 | A (machine API) |
...
| Wet-bulb temperature profile <br>`wtr.wetbulb_profile` | 3850.9 | hours_above_24C_wetbulb | 1 | 7 | A (machine API) |
...
| Terrain slope <br>`lnd.slope` | 0.54 | percent_slope | 99 | 6 | A (machine API) |
...
| Extreme heat trend to 2050 <br>`clm.extreme_heat_trend` | 0.97 | delta_C_design_day_2050 | 83 | 5 | D (modeled) |
...
| Port and rail access <br>`eco.port_rail_access` | 2.34 | km_to_capable_port_or_rail | 99 | 4 | B (bulk/structured) |
...
| Internet exchange and cloud on-ramp proximity <br>`cnx.ixp_proximity` | 77.64 | km | 74 | 3 | A (machine API) |
