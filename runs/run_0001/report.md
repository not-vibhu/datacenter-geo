...
| Transmission line proximity <br>`pwr.transmission_proximity` | 0.97 | km | 98 | 9 | A (machine API) |
...
| Zoning and entitlement status <br>`lnd.zoning_status` | by_right_industrial | category | 100 | 8 | B (bulk/structured) |
| Large-load tariff availability <br>`pwr.large_load_tariff` | — | category | — | 8 | — (unmeasured) |
| On-site generation potential <br>`pwr.onsite_generation_potential` | 74.7 | index_0_100 | 75 | 8 | B (bulk/structured) |
...
| Dry-bulb temperature profile and free-cooling hours <br>`clm.dry_bulb_profile` | 7271.5 | free_cooling_hours_per_year | 90 | 7 | A (machine API) |
| Residential proximity and noise exposure <br>`com.residential_proximity` | 1133 | dwellings_within_1km | 18 | 7 | A (machine API) |
| Long-haul fiber proximity <br>`cnx.longhaul_fiber_proximity` | 2.06 | km | 92 | 7 | C (researched) |
...
| Wet-bulb temperature profile <br>`wtr.wetbulb_profile` | 230.2 | hours_above_24C_wetbulb | 84 | 7 | A (machine API) |
...
| Reclaimed water availability <br>`wtr.reclaimed_availability` | 3.04 | km_to_wwtp | 88 | 6 | B (bulk/structured) |
| Extreme heat trend to 2050 <br>`clm.extreme_heat_trend` | 1.67 | delta_C_design_day_2050 | 63 | 5 | D (modeled) |
...
| Port and rail access <br>`eco.port_rail_access` | 20.37 | km_to_capable_port_or_rail | 93 | 4 | B (bulk/structured) |
...
| Internet exchange and cloud on-ramp proximity <br>`cnx.ixp_proximity` | 3.08 | km | 98 | 3 | A (machine API) |
